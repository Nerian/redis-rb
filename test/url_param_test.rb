...
class TestUrlParam < Test::Unit::TestCase
  ...
  def test_allows_to_pass_in_a_url
    redis = Redis2.new :url => "redis://:secr3t@foo.com:999/2"
  ...
  def test_unescape_password_from_url
    redis = Redis2.new :url => "redis://:secr3t%3A@foo.com:999/2"
  ...
  def test_does_not_unescape_password_when_explicitly_passed
    redis = Redis2.new :url => "redis://:secr3t%3A@foo.com:999/2", :password => "secr3t%3A"
  ...
  def test_override_url_if_path_option_is_passed
    redis = Redis2.new :url => "redis://:secr3t@foo.com/foo:999/2", :path => "/tmp/redis.sock"
  ...
  def test_overrides_url_if_another_connection_option_is_passed
    redis = Redis2.new :url => "redis://:secr3t@foo.com:999/2", :port => 1000
  ...
  def test_does_not_overrides_url_if_a_nil_option_is_passed
    redis = Redis2.new :url => "redis://:secr3t@foo.com:999/2", :port => nil
