...
class TestTransactions < Test::Unit::TestCase
  ...
  def test_assignment_inside_multi_exec_block_with_delayed_command_errors
    ...
    assert_raise(Redis2::CommandError) { @second.value }
    assert_raise(Redis2::FutureNotReady) { @third.value }
  end
  ...
  def test_raise_command_errors_when_accessing_futures_after_multi_exec
    ...
    # We should test for Redis2::Error here, but hiredis doesn't yet do
